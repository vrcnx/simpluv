...
const POOL: Record<string, ProductReviews> = {
  "sleeveless-polo": {
    ...
    reviews: [
      ...
      { name: "Hadley W.", initial: "H", date: "October 9, 2025", rating: 5, title: "Worth every penny", body: "Cut is so flattering, doesn't ride up on the swing. Held up beautifully through 3 rounds and a wash, no pilling at all. The pearl buttons are such a thoughtful touch.", size: "Small", height: "5'5\"", verified: true, fit: "True to Size" },
